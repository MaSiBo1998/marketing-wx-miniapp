        ...
        <button open-type="getPhoneNumber" @getphonenumber="onGetPhoneNumber">手机号</button> -->
			...
			<!-- <u-collapse ref="collapseRef" :border="false" accordion :value="activeNames">
				<u-collapse-item title="查看更多" name="first"> -->
					...
					<u-input :disabled="!isEdit" v-model="userInfo.graduationSchool" border="none"
						placeholder="请输入毕业院校">
						<view class="input-info" slot="prefix">
							毕业院校：
						</view>
					...
					<u-input :disabled="!isEdit" v-model="userInfo.performanceCases" border="none"
						placeholder="请输入演出案例">
						<view class="input-info" slot="prefix">
							演出案例：
						</view>
					...
					<view class="user-info-item">
						...
						<view class="user-info-item-right" v-if="!isEdit">
							<u-album singleSize="50" multipleSize="50" :urls="userInfo.coverImage"
								:maxCount="9"></u-album>
						</view>
						<view class="user-info-item-right" v-else>
...
<!-- 				</u-collapse-item>
			...
			<!-- 报名状态切换 -->
			<u-tabs style="margin: 32rpx auto;" :list="tabList" :current="currentTabIndex" @change="changeTab"
